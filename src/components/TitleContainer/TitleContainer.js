    ...
    return (
      <div className="title-container container">
        <div className="flex-container title">
          <h1 className="font-xl title-h1">Roman</h1>
          <h2 className="font-lg title-h2">Junior Frontend Developer/Designer</h2>
          <ul className="flex-container icon-container">
            <li>
              <a
        ...
        <div className="flex-container desk-container">
          <img className='desk-img' src={desk} />
        </div>
      </div>
    )
  }
